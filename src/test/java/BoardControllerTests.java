...
//        log.info(mockMvc.perform(MockMvcRequestBuilders.get("/board/list")).andReturn().
    ...
    public void testModify() throws Exception{
        ...
        .param("bno","1").param("title","수정된 테스트 새클 제목").param("content","수정된 테스트 새글 내용")
                .param("writer","user12")).andReturn().getModelAndView().getViewName();
        log.info(resultPage);
    ...
    public void testRemove() throws Exception{
        ...
        String resultPage = mockMvc.perform(MockMvcRequestBuilders.post("/board/remove").param("bno","40")).andReturn().getModelAndView().getViewName();
